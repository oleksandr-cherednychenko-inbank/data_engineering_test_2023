...
create or replace TABLE TST_BLACKLIST (
	USER_ID NUMBER(38,0),
...
create or replace TABLE TST_CURRENCIES (
...
create or replace TABLE TST_CURRENCY_RATES (
	CURRENCY_ID NUMBER(38,0),
	EXCHANGE_RATE_TO_EUR NUMBER(38,2),
	EXCHANGE_DATE DATE
);

create or replace TABLE TST_PAYMENTS (
...
INSERT INTO TST_BLACKLIST (USER_ID,BLACKLIST_CODE,BLACKLIST_START_DATE,BLACKLIST_END_DATE) VALUES
	 (3837,101,'2022-01-01',NULL);
	
INSERT INTO TST_CURRENCIES (CURRENCY_ID,CURRENCY_CODE,START_DATE,END_DATE) VALUES
...
INSERT INTO TST_CURRENCY_RATES (CURRENCY_ID,EXCHANGE_RATE_TO_EUR,EXCHANGE_DATE) VALUES
	 (222,0.19,'2023-01-05'),
	 (222,0.20,'2023-02-05'),
	 (222,0.21,'2023-03-05');

INSERT INTO TST_PAYMENTS (USER_ID_SENDER,CONTRACT_ID,AMOUNT,CURRENCY,TRANSACTION_DATE) VALUES
